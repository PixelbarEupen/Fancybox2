					...
					$content .= '<div class="tabs-content">';
						...
						while(has_sub_field('tabs')):
							...
							$content .= '<div class="content '.$content_class.'" id="'.sanitize_title(get_sub_field('titel')).'">';
								$content .= '<div class="large-12 column "><h2 class="tab-title"><span>'.get_sub_field('titel').'</span></h2></div>';
								...
								$content .= '<div class="images large-4 column '.$class.'">';
									...
									$content .= '</a>';
								$content .= '</div>';
								$content .= '<div class="large-8 column">'.get_sub_field('inhalt').'</div>';
							$content .= '</div>';
							$content_i++;
						endwhile;
					$content .= '</div>';
